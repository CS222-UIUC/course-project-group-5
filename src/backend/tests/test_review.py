...
class TestReview:
    ...
    def test_username(self):
        ...
        assert self.sample_username == self.sample_review.get_username()

    def test_date(self):
        """Test class stores correct date"""
        assert self.sample_date == self.sample_review.get_date()

    def test_comment(self):
        """Test class stores correct comment"""
        assert self.sample_comment == self.sample_review.get_comment()

    def test_vote(self):
        """Test class stores correct vote"""
        assert self.sample_vote == self.sample_review.get_vote()
